...
live_design! {
    ...
    BoxLabel = <P> { width: Fit, align: { x: 0.5 } }
        ...
        demos = {
            ...
            <UIZooRowH> {
                ...
                <Box> {
                    ...
                    <BoxLabel> { text: "padding: { left: 0, right: 10. }" }
                }
                <Box> {
                    align: { x: 0., y: 0 }
                    width: Fit, height: Fit,
                    padding: { left: 10., top: 0, right: 0, bottom: 20. }
                    <BoxLabel> { text: "padding: { left: 10., top: 0, right: 0, bottom: 20. }" }
                }
            }
                    ...
                    Desktop = {
                        ...
                        <View> {
                            ...
                            <View> {
                                ...
                                padding: 10.,
                                <H2> { width: Fit, height: Fit, text: "Content" }
                            }
                        }
                    }
