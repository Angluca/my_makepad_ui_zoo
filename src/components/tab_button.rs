        ...
        demos = {
            ...
            <UIZooRowH> {
                ...
                <Button> {
                    draw_bg: {
                        color_2: #f00,
                        let color_2_hover = #f20;
                        let color_2_down = #f60;
                        let color_2_focus = #fA0;
                        let color_2_disabled = #ff0;

                        let border_color_2: #0f0;
                        border_color_2_hover: #0f2,
                        border_color_2_down: #0f6,
                        border_color_2_focus: #0fA,
                        border_color_2_disabled: #0ff,
                    }
                }
...
pub fn handle_actions(app: &mut App, cx: &mut Cx, actions:&Actions) {
    if app.ui.button(ids!(basic_button)).clicked(&actions) {
        log!("BASIC BUTTON CLICKED {}", app.counter);
        app.counter += 1;
        app.ui.button(ids!(basic_button))
            .set_text(cx, &format!("Clicky clicky! {}", app.counter));
    }
    else if app.ui.button(ids!(icon_button)).clicked(&actions) {
        log!("BASIC BUTTON CLICKED {}", app.counter);
        app.counter += 1;
        app.ui.button(ids!(icon_button))
            .set_text(cx, &format!("Clicky clicky! {}", app.counter));
    }
}
